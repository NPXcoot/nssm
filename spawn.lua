...
nssm:spawn_specific("nssm:stone_eater", {"default:stone"}, {"default:stone"}, 0, 20, 40, 700, 2, -31000, -200) -- change highest level to -100 otherwise too easy to find ores!
-- -- nssm:spawn_specific("nssm:signosigno", {"default:stone"}, {"default:stone"}, 0, 10, 20, 400, 2, -31000, -20)
nssm:spawn_specific("nssm:signosigno", {"bones:bones"}, {"air"}, 0, 15, 3, 10, 5, -31000, 31000)
-- 
-- -- SEA
...
nssm:spawn_specific("nssm:icesnake", {"default:snowblock", "default:ice", "default:dirt_with_snow"}, {"default:snowblock", "default:ice", "default:dirt_with_snow"}, 0, 20, 30, 10000, 1, -31000, 50) -- changed max height from 31000 so the spawn area does not get mobbed
nssm:spawn_specific("nssm:white_werewolf", {"default:dirt_with_snow","default:snowblock"}, {"air"}, 0, 20, 60, 20000, 1, -31000, 50)
nssm:spawn_specific("nssm:snow_biter", {"default:snowblock", "default:ice", "default:dirt_with_snow"}, {"default:snowblock", "default:ice", "default:dirt_with_snow"}, 0, 20, 30, 10000, 1, -31000, 50)
-- 
-- 
-- -- FOREST
...
-- 
-- -- SKY
nssm:spawn_specific("nssm:moonheron", {"air"}, {"air"}, 0, 10, 100, 5000000, 1, 10, 40)
...
nssm:spawn_specific("nssm:scrausics", {"air"}, {"air"}, 10, 20, 100, 5000000, 1, 10, 40)
-- 
-- -- PINE FOREST
